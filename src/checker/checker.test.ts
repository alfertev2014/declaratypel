...
import { inferType } from './index.ts'
import { decl, defVar, id, lambda, literal, obj, propValue, VAR_DEFINITION } from '../types/ast/sourceExpressions.ts'
import { BUILTIN, builtinType, FUNCTIONAL, LITERAL_TYPE, NUMBER, OBJECT } from '../types/ast/typeExpressions.ts'
